...
## Batch 2 expansion (atlas/overnight-features): 40 more words, first-search-hit pictograms

Not visually QA-reviewed — same caveat as the first 50-word batch.

- core.touch ("touch" via "touch"): arasaac_id=3293 keyword="touch"
- core.taste ("taste" via "taste"): arasaac_id=37834 keyword="spicy"
- core.smell ("smell" via "smell"): arasaac_id=25275 keyword="smell"
- core.hear ("hear" via "hear"): arasaac_id=6572 keyword="hear"
- core.talk ("talk" via "talk"): arasaac_id=6517 keyword="speak"
- core.call ("call" via "phone call"): arasaac_id=31485 keyword="telephone number"
- core.bring ("bring" via "bring"): arasaac_id=7280 keyword="bring"
- core.carry ("carry" via "carry"): arasaac_id=8983 keyword="support"
- core.leave ("leave" via "leave"): arasaac_id=2806 keyword="exit"
- core.stay ("stay" via "stay"): arasaac_id=34337 keyword="half-stay unit"
- core.catch ("catch" via "catch ball"): arasaac_id=8087 keyword="arrest"
- core.throw ("throw" via "throw ball"): arasaac_id=31071 keyword="roll the die"
- core.wash ("wash" via "wash hands"): arasaac_id=9006 keyword="wash the car"
- core.dress ("dress" via "get dressed"): arasaac_id=6627 keyword="dress"
- core.share ("share" via "share"): arasaac_id=38900 keyword="share"
- core.choose ("choose" via "choose"): arasaac_id=30510 keyword="choose"
- core.hug ("hug" via "hug"): arasaac_id=4550 keyword="hug"
- core.wave ("wave" via "wave hello"): arasaac_id=37633 keyword="seaquake"
- core.knock ("knock" via "knock door"): arasaac_id=38768 keyword="knock against something"
- core.visit ("visit" via "visit"): arasaac_id=27126 keyword="visit"
- core.full ("full" via "full glass"): arasaac_id=4769 keyword="glass of milk"
- core.empty ("empty" via "empty"): arasaac_id=26527 keyword="empty"
- core.round ("round" via "round"): arasaac_id=38116 keyword="ride on a merry-go-round"
- core.long ("long" via "long"): arasaac_id=26162 keyword="long"
- core.short ("short" via "short"): arasaac_id=26002 keyword="short"
- core.tall ("tall" via "tall"): arasaac_id=25782 keyword="tall"
- core.beautiful ("beautiful" via "beautiful"): arasaac_id=26114 keyword="handsome"
- core.kind ("kind" via "kind"): arasaac_id=33994 keyword="kind"
- core.shy ("shy" via "shy"): arasaac_id=8707 keyword="shy"
- core.surprised ("surprised" via "surprised"): arasaac_id=35529 keyword="surprised"
- core.brave ("brave" via "brave"): arasaac_id=36163 keyword="brave"
- core.curious ("curious" via "curious"): arasaac_id=27706 keyword="curious"
- core.homework ("homework" via "homework"): arasaac_id=11228 keyword="homework"
- core.pencil ("pencil" via "pencil"): arasaac_id=2440 keyword="pencil"
- core.paper ("paper" via "paper"): arasaac_id=8349 keyword="paper"
- core.desk ("desk" via "desk"): arasaac_id=5972 keyword="front desk"
- core.class ("class" via "classroom"): arasaac_id=9815 keyword="classroom"
