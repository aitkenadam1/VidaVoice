...
void main() {
  ...
  test('en and es share identical levels', () {
    ...
    expect(
      ...
      levels(en),
      reason:
          'A bilingual child must see the SAME board in both languages. '
          'A word revealed in English but locked in Spanish would move the '
          'board out from under them on a language switch.',
    );
  });
